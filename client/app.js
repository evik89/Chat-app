...
const chatComponent = {
    template: ` <div class="chat-box">
                   <p v-for="data in content">
                       <img class="circle" width="30px" v-bind:src="data.avatar">
...
const usersComponent = {
    template: ` <div class="user-list">
                   ...
                   <ul v-for="user in users">
                       <li>
                            <img class="circle" width="30px" v-bind:src="user.avatar">
                            <span>{{user.name}}</span>
                       </li>
                       <hr>
                   </ul>
...
const welcomeComponent = {
    template: `<h2 style="background-color: #7b7d7d;" v-if="user.name != null">
    WELCOME {{user.name}}
    <br/>
    <img class="circle" width="80px" v-bind:src="user.avatar"> 
    <br/>
</h2>`,
    props: ['user']
}
